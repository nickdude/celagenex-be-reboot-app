...
const useAuth = (fetchUserDetails, navigate) => {
  ...
  const handleRegister = async (formData, activeTab, registerWithPhone,selectedState) => {//selectedState
  ...
  const handlePasswordSubmit = async (formData, activeTab,selectedState) => {//selectedState
  ...
  const handleOtpVerify = async (formData, activeTab, registerWithPhone,selectedState) => {//selectedState
